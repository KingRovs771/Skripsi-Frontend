...
import { LayoutDashboard, Newspaper, FileText, Users, LogOut, School, ShieldCheck, ChevronRight, ChevronDown, Menu, X, BarChart3, Database, ShieldAlert, ScrollText, AlertTriangle } from 'lucide-react';
...
function AdminSidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  const navItems = [
    ...
    { href: '/admin/bully-stats', icon: AlertTriangle, label: 'Statistik Bully' },
    { href: '/admin/backup', icon: Database, label: 'Manajemen Backup' },
    { href: '/admin/retention', icon: ShieldAlert, label: 'Retensi Data' },
    { href: '/admin/audit', icon: ScrollText, label: 'Audit Log KB' },
  ];
