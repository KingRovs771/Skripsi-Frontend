...
import { LayoutDashboard, Newspaper, FileText, LogOut, Database, MessageCircleQuestionMark, ChevronDown, ChevronRight, Menu, X } from 'lucide-react';
  ...
  return (
    <header className="bg-white border-b border-slate-200 h-16 flex items-center justify-between lg:justify-end px-4 lg:px-6 shadow-sm z-30 relative">
      ...
      <div className="flex items-center space-x-3 lg:space-x-4">
        <span className="text-xs lg:text-sm font-semibold text-slate-700 hidden sm:block">Welcome, Pakar!</span>
