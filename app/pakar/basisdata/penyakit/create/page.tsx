  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error(json.Message || json.error || 'Gagal menyimpan penyakit.');
      }
    } catch (error) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      ...
      <div>
        ...
        <p className="text-slate-500 text-base mt-2">Daftarkan penyakit beserta deskripsi dan solusinya.</p>
      </div>
