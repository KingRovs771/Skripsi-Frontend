...
export default function EditPenyakitPage() {
  ...
  useEffect(() => {
    ...
    const fetchPenyakit = async () => {
      try {
        // Fetch data penyakit yang sedang diedit
  ...
  // Catatan: kode_penyakit bersifat read-only di halaman edit, tidak perlu divalidasi
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-sm text-slate-500 font-medium">Memuat data penyakit...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      ...
      <div>
        ...
        <p className="text-slate-500 text-base mt-2">
          Perbarui informasi, deskripsi, atau saran penanganan dari penyakit terkait.
        </p>
      </div>
        ...
        <div className="p-8 space-y-8">
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Kode Penyakit — READ-ONLY, tidak bisa diubah karena merupakan identifier unik */}
              <div className="space-y-2">
                <label htmlFor="kode_penyakit" className="text-sm font-semibold text-slate-700 flex items-center gap-1.5">
                  Kode Penyakit
                ...
                <input
                  ...
                  readOnly
                  tabIndex={-1}
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-base text-slate-500 font-mono cursor-not-allowed select-all uppercase"
                  value={formData.kode_penyakit}
                />
                <p className="text-xs text-slate-400">
                  Kode tidak dapat diubah setelah data tersimpan.
                </p>
              </div>
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                >
                  ...
                  {penyakitList
                    .filter((p) => p.kode_penyakit !== formData.kode_penyakit) // hindari self-reference
                    .map((p) => (
