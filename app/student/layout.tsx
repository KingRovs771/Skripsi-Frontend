...
import { LayoutDashboard, FileCheck, LogOut, FlaskConical, MessageCircleQuestionMark, ChevronDown, ChevronRight } from 'lucide-react';
  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 p-4 flex flex-col">
      <div className="flex items-center space-x-2 mb-8 px-2">
        ...
        <span className="font-bold text-lg">Students Panel</span>
      </div>
  ...
  return (
    <header className="bg-white border-b border-slate-200 h-16 flex items-center justify-end px-6">
      <div className="flex items-center space-x-4">
        <span className="text-sm font-medium">Welcome, Students!</span>
